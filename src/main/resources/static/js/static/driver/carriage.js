    ...
    function refresh(id) {
        if (id===0 || id===1|| id ===2){
            table.render({
                ...
                height: 'full-170',
                url: nginx_url + '/driver/findCarriageByDriverIdAndState/'+login+'/'+array1[id],
                dateFormat: "json",
                limit: 10,
                limits: [10],
                request: {
                ...
                , cols: [[
                    ...
                    {field: 'reciverPhone', title: '收货联系人电话', align: 'center'},
        ...
        if (id===3){
            table.render({
                elem: '#cargoReceiptTable' + (id + 1),
                height: 'full-170',
                url: nginx_url + '/driver/findCarriageByDriverId/'+login,
                limit: 10,
                limits: [10],
                request: {
                    pageName: 'pageNum' //页码的参数名称，默认：page
